              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Row(
                              children: List.generate(3, (index) => VxBox().size(40, 40).roundedFull.color(Vx.randomPrimaryColor).margin(const EdgeInsets.symmetric(horizontal: 4))
                                  .make()
                              ),
                            ),
                          ],
                    ...
                    10.heightBox,
                    "This is a dummy item and description...".text.color(darkFontGrey).make(),
